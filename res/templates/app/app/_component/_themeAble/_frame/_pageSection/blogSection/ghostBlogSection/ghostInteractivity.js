export default function (evTarget) {
    !function() {
        const ffff = function(e) {
            ...
            const k = ()=>{
                ...
                t.style.setProperty("--seek-before-width", o.value / o.max * 100 + "%"),
            ...
            n.readyState > 0 ? (p(),
            L(),
            f()) : n.addEventListener("loadedmetadata", (()=>{
                p(),
                L(),
                f()
            }
        ...
        , t = evTarget.querySelectorAll(".kg-audio-card");
        for (let a = 0; a < t.length; a++)
            ffff(t[a])
    }(),
    evTarget.querySelectorAll(".kg-gallery-image img").forEach((function(e) {
    ...
    function() {
        const e = evTarget.getElementsByClassName("kg-toggle-heading")
        , t = function(e) {
    ...
    function() {
        const e = function(e) {
            ...
            b(),
            S(),
            c.autoplay && (y = requestAnimationFrame(p),
            i.classList.add("kg-video-hide"),
            o.classList.remove("kg-video-hide")),
            c.muted && (l.classList.add("kg-video-hide"),
        ...
        , t = evTarget.querySelectorAll(".kg-video-card");
        for (let a = 0; a < t.length; a++)
            e(t[a])
    }();
}